export const productTypes = [
  {
    ...
    // Add an images array (point these to files you added under public/product_images_info)
    images: [
      "/product_images_info/falcon-1.png",
      "/product_images_info/falcon-2.png",
      "/product_images_info/falcon-3.png",
    ],
    intro:
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "The integrated switching matrix makes it simple to assign connected polarisation levels to each receiver tuner, removing the need for additional external devices — saving space, material and installation time.",
      },
      {
        heading: "Efficient CAM usage",
        body:
          "Models with CI slots can be equipped with up to eight CAM modules for central decryption. Multiplexing at the input of the CI interfaces ensures CAM capacity is used effectively, so products remain scalable and cost-efficient.",
      },
      {
        heading: "Output-side multiplexing",
        body:
          "Additional multiplexing at the output allows channels to be processed in any combination of programmes, within the bandwidth and data rate limits of the applicable broadcast standard.",
      },
      {
        heading: "IP streaming",
        body:
          "IP-streamer models can process up to 256 SPTS streams as UDP/RTP unicast or multicast. Channel lists are generated via SAP protocol or M3U data depending on the connected IP receiver device.",
      },
    ],
  },
  {
    ...
    images: [
      "/product_images_info/tangram-1.png",
      "/product_images_info/tangram-2.png",
    ],
    ...
    sections: [
      {
        ...
        body:
          "The new generation of our Tangram video platform allows for not only increased performance, but also creates a bridge between your non-linear sources to linear content networks.",
      },
      {
        heading: "Modular platform for Edge and Central Office",
        body:
          "Tangram is built for both centralised and distributed headend architectures. Use it in CO, for DVB-IP gateway processing, descrambling, remuxing, scrambling and modulation.",
      },
      {
    ...
    sections: [
      {
        ...
        body:
          "The integrated components can adapt their function depending on requirements. They are designed for all current and future applications. Suited for the transition from the analogue to digital era.",
      },
      {
      ...
      },
      {
        ...
        body:
          "The headend system Chameleon provides the user with universal applications. The Chameleon modules are fully flexible configurable via software. This concept is unprecedented in the industry.",
      },
      {
  ...
  },
  {
    ...
    images: [
      "/product_images_info/optopus-1.png",
    ],
    ...
    sections: [
      {
        ...
        body:
          "The Optopus platform needs less space compared to other products. The 14 slots of the LX 50 base unit can be fully equipped with high-density dual transmitters, allowing 28 different data channels.",
      },
      {
        heading: "Reduce outages caused by maintenance",
        body:
          "The cooling and ventilation system of the Optopus is designed to prolong the operating lifetime of the modules. For instance, the equipment uses a passive cooling without active fans or moving parts.",
      },
      {
        heading: "Flexibility, easy management and monitoring",
        body:
          "The modular concept of the Optopus platform allows for every possible application combination in a single system. Not only does the system offer comprehensive local and remote monitoring, it also supports field upgrades.",
      },
    ],
  },
]
